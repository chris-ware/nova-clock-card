...
Nova.booting(function (Vue, router) {
    Vue.component('nova-clock-card', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.request().get('/nova-vendor/nova-clock-card/timezone').then(function (response) {
            _this2.timezone = response.data;
            _this2.updateCurrentTime();
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "px-3 py-3" }, [
        _c("h1", {
          staticClass: "text-center text-3xl te text-80 font-light",
          domProps: { textContent: _vm._s(_vm.time) }
        }),
        _vm._v(" "),
        _c("p", {
          staticClass: "text-center font-light",
